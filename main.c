...
int main(int argc, char *argv[]) {
    ...
    double **training_inputs = malloc(sizeof(double *) * 100);
    for(int i = 0; i < 100; ++i){
    ...
    double **training_expected = malloc(sizeof(double *) * 100);
    for(int i = 0; i < 100; ++i){
    ...
    train_neural_network(neural_network, training_inputs, training_expected, validation_inputs, validation_expected, 100, 10, 100, 50);
